...
class Vector2 :
    ...
    def soustraction (self, vec1 ,vec2):
        x = vec1.x
        y = vec2.y
        x2 = vec2.x
        y2 = vec2.y
...
font = pygame.font.Font('freesansbold.ttf', 20)  #font=police d'écriture
...
while not isDead:
    ...
    #si on veut détectée une touche est pressée une *
